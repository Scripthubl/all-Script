...
ImageButton.Image = "rbxassetid://104267449555075" -- Open image asset ID
...
ImageButton.MouseButton1Click:Connect(function()
    ...
    if isOpen then
        ImageButton.Image = "rbxassetid://117742570323312" -- Replace with close image asset ID
    else
        ImageButton.Image = "rbxassetid://117742570323312" -- Open image asset ID
    end
...
do
	...
	InterfaceManager:SetFolder("php Hub")
